...
const CustomerDetails: FC<CustomerDetailsProps> = ({
  ...
  return (
    <div className="flex w-full flex-col items-end gap-5">
      ...
      <div className="flex w-full flex-col gap-3 bg-primary/30 px-12 py-6">
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          <div className="flex w-full flex-col gap-2">
            <p className="text-semibold text-[#FBEAD2]">Date & Time</p>
            <p className="font-light text-[#FBEAD2]">
              {form.watch("date")
          ...
          <div className="flex w-full flex-col gap-2">
            <p className="text-semibold text-[#FBEAD2]">No of Guests</p>
            <p className="font-light text-[#FBEAD2]">
              {form.watch("guests")
          ...
          <div className="flex w-full items-center md:justify-center">
            <p
              className="w-fit cursor-pointer border-b-[1px] border-b-[[#FBEAD2]] text-[#FBEAD2]"
              onClick={() => setpage(0)}
            >
              Change Selection
            </p>
      ...
      <p className="w-full text-2xl font-semibold text-[#FBEAD2]">
      ...
      <div className="grid w-full grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="text-[#FBEAD2]">Your Name</FormLabel>
              <FormControl>
                <Input
                  {...field}
                  className="h-12 border-muted bg-transparent text-[#FBEAD2]"
                />
              </FormControl>
              <FormMessage />
            </FormItem>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="text-[#FBEAD2]">Your Email</FormLabel>
              <FormControl>
                <Input
                  {...field}
                  type="email"
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="text-[#FBEAD2]">Phone Number</FormLabel>
              <FormControl>
                <Input
                  {...field}
                  type="tel"
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="text-[#FBEAD2]">Place</FormLabel>
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                ...
                <SelectContent className="max-h-[300px] text-[#FBEAD2]">
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem className="w-full">
            <FormLabel className="text-[#FBEAD2]">Special Request</FormLabel>
            <FormControl>
              <Textarea
                {...field}
                className="min-h-[100px] border-muted bg-transparent text-[#FBEAD2]"
      ...
      <div className="flex w-full justify-center">
        <Button
          type="submit"
          className="right-1 w-fit border bg-transparent px-6 py-6 text-[#FBEAD2] ring-[#CDAE64] md:float-right md:w-fit"
