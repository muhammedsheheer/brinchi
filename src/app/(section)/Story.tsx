      ...
      <div className="flex flex-col">
        <div className="flex h-full w-full flex-col lg:h-[50vh] lg:flex-row">
          <div className="flex w-full flex-col justify-center gap-4 bg-[#161616] px-4 py-12 lg:w-[40%] lg:gap-6 lg:px-[50px]">
            <h3 className="font-playfair text-3xl font-[400] capitalize text-[#FBEAD2] lg:text-5xl">
              Scroll our Story
            </h3>
            ...
            <div>
              <Link href={"#"}>
                <Button className="rounded-none bg-[#D5A859] px-8 py-6 text-center text-xs font-[400] uppercase tracking-[5px] text-[#000]">
                  @BIRCHISTEAK
                </Button>
              </Link>
            </div>
        ...
        <div className="flex h-full w-full flex-col lg:h-[50vh] lg:flex-row">
          ...
          <div className="relative hidden w-full bg-[#D5A859] lg:block lg:w-[30%]">
            <div className="absolute inset-0 flex items-center justify-center">
              <Image
